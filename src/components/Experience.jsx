...
function OrganizationSelector({ journey, index, active, onSelect }) {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className="
        group relative w-full text-left py-7
    ...
    >
      <motion.div
        ...
        className="absolute inset-0 bg-gradient-to-r from-mint-500/[0.08] to-transparent"
      />
      ...
      <motion.div
        ...
        className="absolute left-0 top-0 bottom-0 w-[2px] origin-center bg-mint-500 shadow-[0_0_15px_rgba(34,197,94,.5)]"
      />

      <motion.div
        animate={{ x: selected ? 15 : 0 }}
      ...
      >
        <div
          className="
            ...
            bg-mint-500/[0.07] border border-mint-500/15
            font-mono text-[9px] text-mint-600 dark:text-mint-400
            ...
            {role.metrics.map((metric, index) => (
              <motion.div
                ...
                className="
                  ...
                  bg-black/[0.025] dark:bg-white/[0.03] p-4
                "
              >
                ...
                <p className="relative text-2xl font-black text-mint-600 dark:text-mint-400">
                  {metric.value}
                </p>
                <p className="relative mt-1 text-[10px] text-gray-500 dark:text-gray-500">
                  {metric.label}
                </p>
              </motion.div>
            ))}
        ...
        <div className="flex flex-wrap gap-2 mt-8 pt-6 border-t border-black/5 dark:border-white/10">
          {role.skills.map((skill, index) => (
            <motion.span
              ...
              className="
                px-3 py-1.5 rounded-full bg-mint-500/[0.06]
                border border-mint-500/15 text-[10px] font-medium
                text-mint-700 dark:text-mint-400 cursor-default
              "
            >
              {skill}
            </motion.span>
...
function ExperienceStage({ journey, activeRole, setActiveRole }) {
  ...
  return (
    <div
      ...
      className="
        relative min-h-[650px] overflow-hidden rounded-[2rem]
        border border-black/5 dark:border-white/10
        bg-white/55 dark:bg-white/[0.025] backdrop-blur-xl
        shadow-2xl shadow-black/[0.04] dark:shadow-black/20
      "
    >
      <motion.div
      ...
      <div
        className="
          ...
          bg-[size:34px_34px] pointer-events-none
        "
      />
      ...
      <AnimatePresence mode="wait">
        <motion.p
          ...
          exit={{ opacity: 0, x: -30 }}
          className="
            absolute -right-3 top-2 text-[7rem] sm:text-[9rem]
            font-black tracking-[-0.08em] text-black dark:text-white
    ...
    <section id="experience" className="relative py-28 px-6 overflow-hidden">
      <div
        className="
          ...
          w-[750px] h-[550px] rounded-full
          bg-mint-500/[0.04] blur-[130px] pointer-events-none
        "
      />
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          Two communities. Two journeys. Starting hands-on with design and
          growing into creative leadership.
        </motion.p>

        {/* ── FIXED LAYOUT: tighter columns + connecting divider ── */}
        <div className="relative grid lg:grid-cols-[300px_1fr] gap-8 lg:gap-0 items-start">
          ...
          <div className="lg:sticky lg:top-28 lg:pr-8">
            ...
            <motion.div
              ...
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="mt-7 pl-4 border-l border-mint-500/20"
            >
          ...
          {/* connecting divider — fills the visual gap intentionally */}
